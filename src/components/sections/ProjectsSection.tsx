...
const projects = [
  ...
  },
  {
    title: 'Gym website',
    description:
      'An immersive Gym website featuring interactive animations, particle systems, and custom shaders.',
    image: '/Portfoliox/gym.PNG',
    tags: ['React',"Javascript", "Tailwind CSS"],
    liveUrl: 'https://samadoyedemi2006-lang.github.io/Gym/',
    githubUrl: '#',
  ...
  },
  {
    ...
    image: '/Portfoliox/tech.PNG',
    tags: ['TypeScript', 'React', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB' ],
    liveUrl: 'https://techcommunitx.netlify.app/',
    githubUrl: '#',
  ...
  },
  {
    ...
    description:
     'A full-featured e-commerce platform with real-time inventory, AI-powered recommendations, and seamless checkout experience.',
    image: '/Portfoliox/sphere.PNG',
    tags: ['TypeScript', 'React', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB'],
    liveUrl: 'https://samadoyedemi2006-lang.github.io/ShopSphere/#/products',
    githubUrl: '#',
